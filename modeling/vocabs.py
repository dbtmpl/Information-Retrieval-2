...
from onir import vocab, config, util
...
class BertVocab(vocab.Vocab):
    ...
    def encoder(self):
        return {
            'joint': JointBertQQAEncoder,
            'sep': SepBertQQAEncoder,
...
class BaseBertQQAEncoder(vocab.VocabEncoder):
...
class SepBertQQAEncoder(BaseBertQQAEncoder):
...
class JointBertQQAEncoder(BaseBertQQAEncoder):
